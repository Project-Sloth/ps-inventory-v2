...
const InventoryNotify = {
    ...
    Events: {
      ...
      Process: (data, delay = 5000) => {
          ...
          const oldContainerHeight = $(InventoryNotify.Selectors.ToastContainer)[0].offsetHeight;
          ...
          const newContainerHeight = $(InventoryNotify.Selectors.ToastContainer)[0].offsetHeight;
          InventoryNotify.State.OldHeight = newContainerHeight - oldContainerHeight;
  
          // Animate the height of the container
          $(InventoryNotify.Selectors.ToastContainer)[0].height = newContainerHeight;
          ...
          setTimeout(async () => {
              ...
              const newHeight = $(InventoryNotify.Selectors.ToastContainer)[0].height - InventoryNotify.State.OldHeight;
              $(InventoryNotify.Selectors.ToastContainer)[0].height = newHeight;
          ...
          let output = `
                  <div class="inventory-toast">
                        <div class="notify-slot-container">
                            <div class="notify-slot ${data.process == "notification" ? 'notification' : ''}">
                                ${
